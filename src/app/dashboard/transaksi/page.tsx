...
export default function TransaksiPage() {
  ...
  const load = async () => {
    setLoading(true)
    try {
      const res = await fetch(`/api/transaksi?telegram_id=${TELEGRAM_ID}&tanggal=${tanggal}`)
              ...
              <div className="flex items-center gap-3 px-5 py-4">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <p className="text-sm font-semibold text-gray-800 dark:text-white/90">{t.nomor_nota}</p>
